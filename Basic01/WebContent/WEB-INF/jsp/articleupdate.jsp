  ...
  <head>
    ...
    <script type="text/javascript">
    	function updArt() {
			...
			var arstate = document.getElementById("level").value;
			var arid  = document.getElementById("arid").value;
			$.post("${pageContext.request.contextPath}/updateArticle",
					{"caid":caid,"artitle":artitle,"arcontent":arcontent,"aruser":aruser,"arstate":arstate,"arid":arid},
					function(data){
						if(data == "OK"){
							alert("修改成功");
...
#addinfo a{ font-size:14px; font-weight:bold; background:url(background/images/main/addinfoblack.jpg) no-repeat 0 1px; padding:0px 0 0px 20px; line-height:45px;}
#addinfo a:hover{ background:url(background/images/main/addinfoblue.jpg) no-repeat 0 1px;}
</style>
  </head>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <form  action="" onsubmit="updArt()">
    <input type="hidden" name="type" value="">
    <input type="hidden" id="arid" value="${article.arid}">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        	<select id="caid" >
        			<c:forEach var="catalog" items="${CatalogList}">
        				<c:choose>
        					<c:when test="${article.caid eq  catalog.caid}">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" id="artitle" value="${article.artitle}" class="text-word">
        </td>
       </tr>
       <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray" >文章内容：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
			<textarea  style="width: 100%; height: 280px" id="myEditor">
				${article.arcontent}
			</textarea>
		</td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for" >
        	<input type="text" id="aruser" value="${article.aruser}" class="text-word">
        </td>
      </tr>
      
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">文章状态：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <select name="arstate" id="level">
        <c:if test="${article.arstate eq 1}">
        	 <option value="1" selected="selected">&nbsp;&nbsp;显示</option>
		     <option value="2" >&nbsp;&nbsp;不显示</option>
        </c:if>
        <c:if test="${article.arstate eq 2}">

  ...
  <head>
    ...
    <script type="text/javascript">
    	function addCat() {
			...
			var canumber = document.getElementById("canumber").value;
			var castate = document.getElementById("level").value;			
			$.ajax({
				url:"${pageContext.request.contextPath}/addCatalog",
				type:"POST",
				data:{"caname":caname,"canumber":canumber,"castate":castate},				
				success:function(data){	
					if(data == "OK"){
						...
						if(confirm('是否继续添加?')){
							...
							location.href ="${pageContext.request.contextPath}/findCatalogAllPage";
						}
					}else{
						alert("添加失败");
						window.location.reload();
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  <tr>
    <td width="99%" align="left" valign="top">您的位置：用户管理&nbsp;&nbsp;>&nbsp;&nbsp;添加栏目</td>
  </tr>
  <tr>
    <td align="left" valign="top" id="addinfo">
    <a href="add.html" target="mainFrame" onFocus="this.blur()" class="add">添加栏目</a>
    </td>
  </tr>
  <tr>
    <td align="left" valign="top">
    <form method="post" action="" onsubmit="addCat()">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text" name="caname" id="caname" value="" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">栏目序号：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="canumber" id="canumber" value="${nownumber}" readonly="readonly" class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">

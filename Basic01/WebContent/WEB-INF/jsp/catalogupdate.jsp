  ...
  <head>
    ...
    <script type="text/javascript">
    	function updCat() {
			...
			$.ajax({
				url:"${pageContext.request.contextPath}/updateCatalog",
				type:"POST",
				data:{"caid":caid,"caname":caname,"canumber":canumber,"castate":castate},				
